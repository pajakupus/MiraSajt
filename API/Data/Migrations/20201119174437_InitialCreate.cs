    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSizesRel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductSizesRel_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSizesRel_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizesRel_ProductId",
                table: "ProductSizesRel",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSizesRel_SizeId",
                table: "ProductSizesRel",
                column: "SizeId");
        }
